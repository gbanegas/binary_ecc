        84, 4, 84, 5, 84, 16, 84, 17, 84, 20, 84, 21, 84, 64, 84, 65, 84, 68, 84, 69, 84, 80, 84, 81, 84, 84, 84, 85,
        84, 0, 85, 1, 85, 4, 85, 5, 85, 16, 85, 17, 85, 20, 85, 21, 85, 64, 85, 65, 85, 68, 85, 69, 85, 80, 85, 81, 85,
        84, 85, 85, 85
};


ff_element ff_zero = {0, 0, 0, 0, 0, 0, 0, 0, 0};
ff_element ff_one = {1, 0, 0, 0, 0, 0, 0, 0, 0};
...
void reduce(ff_block *a) {
    ...
    ff_block t;
    t = a[BLOCKS2 - 1];
    a[BLOCKS2 - 1 - 8] ^= t >> 20 ^ t >> 15;
    a[BLOCKS2 - 1 - 9] ^= t << 5 ^ t << 10 ^ t << 12 ^ t << 17;
    for (i = 16; i >= 9; i--) {
        t = a[i];
        a[i - 8] ^= t >> 27 ^ t >> 22 ^ t >> 20 ^ t >> 15;
        a[i - 9] ^= t << 5 ^ t << 10 ^ t << 12 ^ t << 17;
    }
    t = a[BLOCKS - 1] & (0xFFFFFFFF - 134217727);
    a[BLOCKS - 1 - 8] ^= t >> 27 ^ t >> 22 ^ t >> 20 ^ t >> 15;
    a[8] &= 134217727;
}
...
void ff_mul_lrcomb_w4(ff_element a, ff_element b, ff_element c) {
    ...
    if (base[1 * BLOCKS + BLOCKS - 1] & 67108864) {
        base[2 * BLOCKS + BLOCKS - 1] &= 134217727;
        base[2 * BLOCKS + 0] ^= 4257;
    }
    ...
    if (base[2 * BLOCKS + BLOCKS - 1] & 67108864) {
        base[4 * BLOCKS + BLOCKS - 1] &= 134217727;
        base[4 * BLOCKS + 0] ^= 4257;
    }
    ...
    if (base[4 * BLOCKS + BLOCKS - 1] & 67108864) {
        base[8 * BLOCKS + BLOCKS - 1] &= 134217727;
        base[8 * BLOCKS + 0] ^= 4257;
    }
...
void ff_rand(ff_element a) {
    ...
    for (i = 0; i < BLOCKS; i++) {
        ...
        randombytes(&a->data[i], sizeof(uint32_t));
        //a->data[i] = (ff_block) rand();
    }
    a->data[BLOCKS - 1] &= 134217727;
}
...
void ff_read(ff_element a) {
    scanf("%x %x %x %x %x %x %x %x %x", a->data + 8, a->data + 7, a->data + 6, a->data + 5, a->data + 4, a->data + 3,
          a->data + 2, a->data + 1, a->data + 0);

    assert(!(a->data[BLOCKS - 1] & !134217727));
    a->data[BLOCKS - 1] &= 134217727;
}

void ff_sread(const char *s, ff_element a) {
    sscanf(s, "%x %x %x %x %x %x %x %x %x", a->data + 8, a->data + 7, a->data + 6, a->data + 5, a->data + 4,
           a->data + 3, a->data + 2, a->data + 1, a->data + 0);
...
void ff_print(ff_element a) {
    printf("[%x %x %x %x %x %x %x %x %x]", a->data[8], a->data[7], a->data[6], a->data[5], a->data[4], a->data[3],
           a->data[2], a->data[1], a->data[0]);
